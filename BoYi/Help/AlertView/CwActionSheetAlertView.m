...
#import "CwActionSheetAlertView.h"

@implementation CwActionSheetAlertView
...
+ (void)showInView:(UIView *)view top:(NSString *)topContent bottom:(NSString *)bottomContent block:(SelectBtnBlock)block
{
    ...
    CwActionSheetAlertView *alertView = [[[NSBundle mainBundle]loadNibNamed:@"CwActionSheetAlertView" owner:self options:nil] lastObject];
