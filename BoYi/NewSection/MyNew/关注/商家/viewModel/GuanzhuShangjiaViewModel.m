...
@implementation GuanzhuShangjiaViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[ShangjiaGuanzhuModel mj_objectArrayWithKeyValuesArray:object[@"shangjia"]]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GuanzhuShangjiaTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"GuanzhuShangjiaTableViewCell"];
