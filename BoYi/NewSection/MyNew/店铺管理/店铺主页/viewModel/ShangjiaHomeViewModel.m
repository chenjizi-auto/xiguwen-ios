...
@implementation ShangjiaHomeViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[ShangjiaHomeViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ShangjiaHomeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ShangjiaHomeTableViewCell"];
