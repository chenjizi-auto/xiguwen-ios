...
@interface MybaojiaSubViewController ()
@property (nonatomic, strong) NSArray *titleNames;
@end

@implementation MybaojiaSubViewController
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    MyBaoJiaViewController *BaoJia = [[MyBaoJiaViewController alloc] init];
//	if (index == 0) {
//		BaoJia.index = 4;
//	} else {
