...
#import "OtherTixingTableViewCell.h"

@implementation OtherTixingViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[OtherTixingViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    OtherTixingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OtherTixingTableViewCell"];
