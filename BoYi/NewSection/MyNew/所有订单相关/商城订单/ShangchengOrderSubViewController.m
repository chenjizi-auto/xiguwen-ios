//
//  ShangchengOrderSubViewController.m
//  BoYi
//
...
@interface ShangchengOrderSubViewController ()
@property (nonatomic, strong) NSArray *titleNames;
@end

@implementation ShangchengOrderSubViewController
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    ShangchengOrderViewController *Order = [[ShangchengOrderViewController alloc] init];
    NSInteger type;
    if (index == 0) {
        type = 0;
    }else if (index == 1){
