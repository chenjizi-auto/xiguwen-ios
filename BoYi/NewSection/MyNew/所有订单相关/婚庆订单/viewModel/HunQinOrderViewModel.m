...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.dataArray[indexPath.row].status == 20 || self.dataArray[indexPath.row].status == 90 || self.dataArray[indexPath.row].payment_dis == 4 ) {
        return 102 + 44 + 58;
    }else {
        return 102 + 44 + 108;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.dataArray[indexPath.row].status == 20 || self.dataArray[indexPath.row].status == 90) {
