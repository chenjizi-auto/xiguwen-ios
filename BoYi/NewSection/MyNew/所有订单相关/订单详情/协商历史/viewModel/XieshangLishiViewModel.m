...
#import "MaiJiaShenqingTuikuanTableViewCell.h"
#import "MaiJiaTongYiTuiHuoTableViewCell.h"
#import "MaiJiaYiTuiHuoTableViewCell.h"

@implementation XieshangLishiViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[Xieshangarray mj_objectArrayWithKeyValuesArray:object]];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [tableView cellHeightForIndexPath:indexPath model:self.dataArray[indexPath.row] keyPath:@"model" cellClass:NSClassFromString(@"XieshangLishiTableViewCell") contentViewWidth:ScreenWidth];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XieshangLishiTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XieshangLishiTableViewCell"];
