//
//  ShangchengOderDetilJDViewController.h
//  BoYi
//
...
@interface ShangchengOderDetilJDViewController : FatherViewController<UITableViewDelegate,UITableViewDataSource>
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *zongheight;
