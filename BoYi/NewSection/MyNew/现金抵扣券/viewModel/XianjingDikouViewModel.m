...
@implementation XianjingDikouViewModel
...
//    
//    [self.dataArray addObjectsFromArray:[XianjingDikouViewModel mj_objectArrayWithKeyValuesArray:object]];
//    
//}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XianjingDikouTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XianjingDikouTableViewCell"];
