...
@implementation HunliXInwenViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[HunliXInwenModel mj_objectArrayWithKeyValuesArray:object]];
...
- (RACCommand *)refreshDataCommand {
    ...
    if (!_refreshDataCommand) {
        ...
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            ...
            @strongify(self);
            return [[RequestManager sharedManager] RACRequestUrl:URL_newsList
                                                          method:POST
                                                          loding:@"加载中..."
                                                             dic:input];
        }];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HunliXInwenTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HunliXInwenTableViewCell"];
	if (!cell) {
		cell = [[HunliXInwenTableViewCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:@"HunliXInwenTableViewCell"];
	}
...
//	return @{@"HunliXInwenModel" : [HunliXInwenModel class]};
//}
