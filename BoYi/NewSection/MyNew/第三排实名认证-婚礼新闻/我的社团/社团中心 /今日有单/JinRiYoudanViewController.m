...
#import "JinRiYoudanViewModel.h"
#import "JinRiYoudanModel.h"
//#import "CwDatePiker.h"
#import "MOFSPickerManager.h"
@interface JinRiYoudanViewController ()

@property (weak, nonatomic) IBOutlet UITableView *table;
@property (strong,nonatomic) JinRiYoudanViewModel *viewModel;
...
@implementation JinRiYoudanViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"今日有单";
...
- (void)cellClick {
    ...
    @weakify(self);
    [self.viewModel.selectItemSubject subscribeNext:^(JinRiYoudanModel *x) {
        @strongify(self);
...
- (void)setupTableView {
    ...
    [self.table registerNib:[UINib nibWithNibName:@"JinRiYoudanTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"JinRiYoudanTableViewCell"];
...
//初始化viewModel
- (JinRiYoudanViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[JinRiYoudanViewModel alloc] init];
    }
    return _viewModel;
}
