...
//	NSString* thumbURL =  self.model.cover;
	UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:[NSString stringWithFormat:@"我用博艺婚嫁创建了“%@”",self.model.name] descr:@"邀请你加入，最好用的婚礼人工具，我们在博艺婚嫁等你哦！" thumImage:@""];
	//设置网页地址
