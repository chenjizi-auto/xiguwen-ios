...
@implementation MyYaoQingViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[InvitationArray mj_objectArrayWithKeyValuesArray:object[@"list"]]];
...
- (RACCommand *)refreshDataCommand {
    ...
    if (!_refreshDataCommand) {
        ...
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            ...
            @strongify(self);
            return [[RequestManager sharedManager] RACRequestUrl:URL_myInvitation
                                                          method:POST
                                                          loding:@""
                                                             dic:input];
        }];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyYaoQingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MyYaoQingTableViewCell"];
...
+ (NSDictionary *)objectClassInArray{
	return @{@"invitationArray" : [InvitationArray class]};
}

@end

@implementation InvitationArray
