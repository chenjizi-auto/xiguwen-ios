...
@interface XuqiuSubViewController ()
@property (nonatomic, strong) NSArray *titleNames;
@end

@implementation XuqiuSubViewController
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    MyXuqiuViewController *Order = [[MyXuqiuViewController alloc] init];
	Order.statusFlag = index;
    return Order;
