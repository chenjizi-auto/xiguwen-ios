...
#import "PingjiaGuanliViewModel.h"
#import "PingjiaGuanliTableViewCell.h"

@implementation PingjiaGuanliViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[PingjiaGuanliViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PingjiaGuanliTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"PingjiaGuanliTableViewCell"];
