...
@implementation ShouHuodizhiViewModel
...
- (RACCommand *)refreshDataCommand {
    if (!_refreshDataCommand) {
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            return [[RequestManager sharedManager] RACRequestUrl:[HOMEURL stringByAppendingString:@"appapi/Address/addresslist"] method:POST loding:@"加载中..." dic:input];
        }];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ShouHuodizhiTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ShouHuodizhiTableViewCell"];
