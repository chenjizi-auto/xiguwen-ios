...
- (void)passwordView:(XLPasswordView *)passwordView didFinishInput:(NSString *)password {
    ...
    if (self.type == 1) {
        ...
        [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/ordershq/buyweddingapp"]
                                            method:POST
                                            loding:@""
                                               dic:self.dicm1
                                          progress:nil
                                           success:^(NSURLSessionDataTask *task, id response) {
                                               ...
                                               if ([response[@"code"] integerValue] == 0) {
                                                   [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/carthq/moneypaywedding"]
                                                                                       method:POST
                                                                                       loding:@""
                                                                                          dic:@{@"pwd":password,
                                                                                                @"id":response[@"data"],
        ...
        [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/orders/createorderapp"]
                                            method:POST
                                            loding:@""
                                               dic:self.dicm3
                                          progress:nil
                                           success:^(NSURLSessionDataTask *task, id response) {
                                               ...
                                               if ([response[@"code"] integerValue] == 0) {
                                                   [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/cart/shopmoneypay"]
                                                                                       method:POST
                                                                                       loding:@""
                                                                                          dic:@{@"pwd":password,
                                                                                                @"id":response[@"data"],
        ...
        [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/Authentication/zhifu"]
                                            method:POST
                                            loding:@""
                                               dic:@{@"id":self.bianhao,
                                                     @"pwd":password,
        ...
        [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/carthq/moneypayweddingwk"]
                                            method:POST
                                            loding:@""
                                               dic:@{@"pwd":password,
                                                     @"orderid":self.bianhao,
                                                     @"token":[UserDataNew sharedManager].userInfoModel.token.token,
                                                     @"userid":@([UserDataNew sharedManager].userInfoModel.token.userid)}
                                          progress:nil
                                           success:^(NSURLSessionDataTask *task, id response) {
        ...
        [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/Member/flowsheet"]
                                            method:POST
                                            loding:@""
...
- (IBAction)sureAC:(UIButton *)sender {
                                              ...
                                              progress:nil
                                               success:^(NSURLSessionDataTask *task, id response) {
                                                   ...
                                                   if ([response[@"code"] integerValue] == 0) {
                                                       ...
                                                       [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/example/hunqindindanapp"]
                                                                                           method:POST
                                                                                           loding:@""
                                                                                              dic:@{@"id":response[@"data"],@"type":idbianhao}
                                                                                         progress:nil
                                                                                          success:^(NSURLSessionDataTask *task, id response) {
    ...
    if (self.type == 2) {
        if (index == 3) {
            ...
            [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/example/hunqindindanapp"]
                                                method:POST
                                                loding:@""
                                                   dic:@{@"id":self.bianhao,@"type":idbianhao}
                                              progress:nil
                                               success:^(NSURLSessionDataTask *task, id response) {
                                              ...
                                              progress:nil
                                               success:^(NSURLSessionDataTask *task, id response) {
                                                   ...
                                                   if ([response[@"code"] integerValue] == 0) {
                                                       ...
                                                       [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/example/zhifudindanapp"]
                                                                                           method:POST
                                                                                           loding:@""
                                                                                              dic:@{@"id":response[@"data"],@"type":idbianhao}
                                                                                         progress:nil
    ...
    if (self.type == 7) {
        if (index == 3) {
            ...
            [[RequestManager sharedManager] requestUrl:[HOMEURL stringByAppendingString:@"appapi/example/weikuanzhifuapp"]
                                                method:POST
                                                loding:@""
                                                   dic:@{@"id":self.bianhao,@"type":idbianhao}
                                              progress:nil
