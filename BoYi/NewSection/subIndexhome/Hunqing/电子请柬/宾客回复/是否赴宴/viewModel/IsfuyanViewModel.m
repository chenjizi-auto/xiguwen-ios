...
@implementation IsfuyanViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[Fuyan mj_objectArrayWithKeyValuesArray:object[@"fuyan"]]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    IsfuyanTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"IsfuyanTableViewCell"];
