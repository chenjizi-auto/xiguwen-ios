//
//  ZiDingYingLanMuViewController.m
//  BoYi
//
...
#import "ZiDingYingLanMuViewModel.h"
#import "ZiDingYingLanMuModel.h"
#import "AnlieListViewController.h"
#import "BannerWebViewController.h"
@interface ZiDingYingLanMuViewController ()

@property (weak, nonatomic) IBOutlet UITableView *table;
@property (strong,nonatomic) ZiDingYingLanMuViewModel *viewModel;
@property (strong,nonatomic) ShareNewmodel *sharemodel;
@end

@implementation ZiDingYingLanMuViewController
...
- (void)shareData{
    NSDictionary *dic = @{@"id":@(self.statusFlag),@"type":@(self.type)};
...
- (void)setupTableView {
    ...
    [self.table registerNib:[UINib nibWithNibName:@"ZiDingYingLanMuTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"ZiDingYingLanMuTableViewCell"];
    [self.table registerNib:[UINib nibWithNibName:@"ZidingyiTwoTableViewCell" bundle:[NSBundle mainBundle]] forHeaderFooterViewReuseIdentifier:@"ZidingyiTwoTableViewCell"];
    [self.table registerNib:[UINib nibWithNibName:@"ZidingyiThreeTableViewCell" bundle:[NSBundle mainBundle]] forHeaderFooterViewReuseIdentifier:@"ZidingyiThreeTableViewCell"];
...
//初始化viewModel
- (ZiDingYingLanMuViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[ZiDingYingLanMuViewModel alloc] init];
    }
    return _viewModel;
}
