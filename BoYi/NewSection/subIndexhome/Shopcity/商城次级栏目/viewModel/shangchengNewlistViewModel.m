...
@implementation shangchengNewlistViewModel
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    shangchengNewlistTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"shangchengNewlistTableViewCell"];
