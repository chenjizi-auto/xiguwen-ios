...
- (void)setModel:(Remensjhot *)model {
    _model = model;
    ...
    self.shangpin.text = [NSString stringWithFormat:@"商品 %ld",model.shopnum];
    self.anlie.text = [NSString stringWithFormat:@"案列 %ld",model.anlinum];
    self.pingjia.text = [NSString stringWithFormat:@"评价 %ld",model.evaluate];
