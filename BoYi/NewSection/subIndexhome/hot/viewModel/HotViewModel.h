...
@interface HotViewModel : NSObject <UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@property (nonatomic, strong) RACSubject *pushUISubject;

@property (nonatomic, strong) RACSubject *bannerUISubject;
//分类列表
