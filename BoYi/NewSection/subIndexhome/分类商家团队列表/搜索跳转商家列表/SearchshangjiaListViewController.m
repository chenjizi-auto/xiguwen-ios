//
//  SearchshangjiaListViewController.m
//  BoYi
//
...
#import "quyuModel.h"
@interface SearchshangjiaListViewController (){
...
@implementation SearchshangjiaListViewController
...
- (void)getFenel{
    ...
    for (int i = 0; i < self.children.count; i++) {
        ...
        modelwu.occupationid = self.children[i].id;
        modelwu.proname = self.children[i].wapname;
        [self.quanbuArray addObject:modelwu];
    }
}
