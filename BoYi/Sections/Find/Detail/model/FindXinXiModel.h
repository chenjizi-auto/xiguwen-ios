...
@class UserinfobvoXinxi,BizworkXinxi;


@interface FindXinXiModel : NSObject
...
@property (nonatomic, strong) UserinfobvoXinxi *userInfoBvo;
...
@interface UserinfobvoXinxi : NSObject

@property (nonatomic, copy) NSString *bizDealCount;

@property (nonatomic, copy) NSString *province;

@property (nonatomic, strong) BizworkXinxi *bizWork;
...
@interface BizworkXinxi : NSObject
