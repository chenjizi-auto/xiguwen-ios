...
@class Createtime,Zone,Uncachedzone,Chronology,Zone,Uncachedzone,Product,Scheduledate,Zone,Uncachedzone,Chronology,Zone,Uncachedzone,Updatetime,Zone,Uncachedzone,Chronology,Zone,Uncachedzone,UserX;
...
@property (nonatomic, assign) NSInteger bizUserId;
...
@property (nonatomic, strong) UserX *user;
...
@interface ScheduledateX : NSObject
