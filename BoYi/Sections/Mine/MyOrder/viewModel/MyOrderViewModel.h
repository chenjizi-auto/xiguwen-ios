...
//评论
@property (nonatomic, strong) RACCommand *submitOrderCommentCommand;
//退款
@property (nonatomic, strong) RACCommand *submitRefundCommand;
//退款
@property (nonatomic, strong) RACCommand *orderPayCommand;
/**
 根据刷新状态，判断数据加载
