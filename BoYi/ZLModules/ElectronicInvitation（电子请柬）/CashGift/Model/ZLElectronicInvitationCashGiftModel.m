...
+ (void)cashGiftDataWithInfoModel:(ZLElectronicInvitationCashGiftModel *)infoModel Results:(void (^)(ZLSessionManagerErrorState sessionErrorState))complete {
    ...
    [ZLHTTPSessionManager requestDataWithUrlPath:@"http://boyi.qanlian.com/appapi/invitation/lijing" Params:dictM POST:YES ModelArray:nil HttpHeader:YES Results:^(ZLSessionManagerErrorState sessionErrorState, id responseObject) {
