...
+ (void)deleteEditTemplatePageDataWithInfoModel:(ZLElectronicInvitationEditTemplateModel *)infoModel Results:(void (^)(ZLSessionManagerErrorState sessionErrorState, NSString *errorMessage))complete {
    ...
    [ZLHTTPSessionManager requestDataWithUrlPath:@"http://www.xiguwen520.com/appapi/Invitation/invitationscreateer" Params:dictM POST:YES ModelArray:nil HttpHeader:YES Results:^(ZLSessionManagerErrorState sessionErrorState, id responseObject) {
...
+ (void)deleteEditTemplateDataWithInfoModel:(ZLElectronicInvitationEditTemplateModel *)infoModel Results:(void (^)(ZLSessionManagerErrorState sessionErrorState, NSString *errorMessage))complete {
    ...
    [ZLHTTPSessionManager requestDataWithUrlPath:@"http://www.xiguwen520.com/appapi/Invitation/delinvitations" Params:dictM POST:YES ModelArray:nil HttpHeader:YES Results:^(ZLSessionManagerErrorState sessionErrorState, id responseObject) {
        if (!sessionErrorState) {
            if ([responseObject[@"code"] intValue]) {
                complete(sessionErrorState,responseObject[@"message"]);
                return ;
