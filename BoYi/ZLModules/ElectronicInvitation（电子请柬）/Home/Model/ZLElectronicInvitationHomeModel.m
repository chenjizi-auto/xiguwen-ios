...
+ (void)electronicInvitationHomeDataWithInfoModel:(ZLElectronicInvitationHomeModel *)infoModel Results:(void (^)(ZLSessionManagerErrorState sessionErrorState))complete {
    ...
    [ZLHTTPSessionManager requestDataWithUrlPath:@"http://www.xiguwen520.com/appapi/Invitation/myinvitations" Params:dictM POST:YES ModelArray:nil HttpHeader:YES Results:^(ZLSessionManagerErrorState sessionErrorState, id responseObject) {
