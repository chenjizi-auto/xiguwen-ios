...
#define zl_scale(value) UIScreen.mainScreen.bounds.size.width / 375.0 * value
...
- (UIView *)unitView {
    if (!_unitView) {
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreen.mainScreen.bounds.size.width, zl_scale(217.0) + (isBangDevice ? 25.0 : 0))];
        ...
        CGFloat width =  zl_scale(90.0) - 1.0;
        CGFloat height = (zl_scale(217.0) - 4.0) / 4;
        for (NSInteger index = 0; index < array.count; index++) {
            CGRect frame = CGRectZero;
            if (index == array.count - 1) {
                frame = CGRectMake(zl_scale(270.0), zl_scale(217.0) / 2.0 + 1.0, UIScreen.mainScreen.bounds.size.width - zl_scale(270.0), zl_scale(217.0) / 2.0 - 1.0);
            }else if (index == array.count - 2) {
                frame = CGRectMake(zl_scale(270.0), 1.0, UIScreen.mainScreen.bounds.size.width - zl_scale(270.0), zl_scale(217.0) / 2.0 - 1.0);
            }else {
