...
public class CalendarAdapter extends BaseAdapter {
    ...
    public CalendarAdapter(Context mContext, List<CalendarBean> mList, CallBack.MainMenuClick mListener, int year, int month) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ViewHolder vh;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_date_lable_layout, null);
