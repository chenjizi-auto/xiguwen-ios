...
public class ExampleFragmentAdapter extends RecyclerView.Adapter<ExampleFragmentAdapter.ViewHolder> {
    Context mContext;
    com.jcodecraeer.xrecyclerview.OnItemClickListener listener;
    private List<CaseBean.DataBean> mlist;
    ...
    public ExampleFragmentAdapter(Context mContext, com.jcodecraeer.xrecyclerview.OnItemClickListener itemClickListener) {
        this.mContext = mContext;
        this.listener = itemClickListener;
    }

    @Override
    public ExampleFragmentAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_example_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ExampleFragmentAdapter.ViewHolder vh, final int position) {
    ...
    public void setData(List<CaseBean.DataBean> mList) {
        this.mlist = mList;
        this.notifyDataSetChanged();
    }

    public void addData(List<CaseBean.DataBean> mlist) {
    ...
    public List<CaseBean.DataBean> getData() {
        return this.mlist;
    }
