...
public class FuyanAdapter extends RecyclerView.Adapter<FuyanAdapter.ViewHolder> {
    Context mContext;
    private List<FuYanBean.InfoBean> mDatas;

    public FuyanAdapter(Context mContext, List<FuYanBean.InfoBean> datas) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_layout_fuyan, parent, false);
