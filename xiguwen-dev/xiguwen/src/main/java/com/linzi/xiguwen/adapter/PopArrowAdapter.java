...
public class PopArrowAdapter extends RecyclerView.Adapter<PopArrowAdapter.ViewHolder> {
    Context mContext;
    List<String> arrow;
    com.jcodecraeer.xrecyclerview.OnItemClickListener itemClickListener;
    int select_point=0;

    public PopArrowAdapter(Context mContext, List<String> arrow, com.jcodecraeer.xrecyclerview.OnItemClickListener itemClickListener) {
    ...
    @Override
    public PopArrowAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.pop_item_arrow_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final PopArrowAdapter.ViewHolder vh, int position) {
        ...
        vh.tvSelectTxt.setText(arrow.get(position));
    }
