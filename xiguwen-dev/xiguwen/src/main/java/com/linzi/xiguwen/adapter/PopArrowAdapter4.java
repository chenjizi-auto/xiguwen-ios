...
public class PopArrowAdapter4 extends RecyclerView.Adapter<PopArrowAdapter4.ViewHolder> {
    Context mContext;
    List<BaseBean> arrow;
    com.jcodecraeer.xrecyclerview.OnItemClickListener itemClickListener;
    int select_point=0;

    public PopArrowAdapter4(Context mContext, List<BaseBean> arrow, com.jcodecraeer.xrecyclerview.OnItemClickListener itemClickListener) {
    ...
    @Override
    public PopArrowAdapter4.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.pop_item_arrow_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final PopArrowAdapter4.ViewHolder vh, int position) {
