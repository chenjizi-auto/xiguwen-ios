...
import com.linzi.xiguwen.adapter.HunQinOrderAdapter;
...
import com.linzi.xiguwen.ui.TuikuanDetailsActivity;
...
public class HunQinOrderFragment extends BaseFragment {
    ...
    HunQinOrderAdapter mAdapter;

    public static HunQinOrderFragment newInstance (int FLAG) {
        Bundle args = new Bundle();
        args.putInt("type", FLAG);
        HunQinOrderFragment fragment=new HunQinOrderFragment();
    ...
    private void initViews(){
        ...
        mAdapter=new HunQinOrderAdapter(getActivity(), flag, new com.jcodecraeer.xrecyclerview.OnItemClickListener() {
            @Override
