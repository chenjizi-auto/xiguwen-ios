...
import com.linzi.xiguwen.ui.TuikuanTypeActivity;
...
public class ShangChengOrderFragment extends BaseFragment {
    ...
    ShangchengOrderAdapter mAdapter;

    public static ShangChengOrderFragment newInstance (int FLAG) {
        Bundle args = new Bundle();
        args.putInt("type", FLAG);
        ShangChengOrderFragment fragment=new ShangChengOrderFragment();
    ...
    private void initViews(){
        ...
        mAdapter=new ShangchengOrderAdapter(getActivity(), flag, new com.jcodecraeer.xrecyclerview.OnItemClickListener() {
            @Override
...
//            }
//        });
        mAdapter.setmTuikuan(new CallBack.TuikuanListener() {
            @Override
            public void tuikuan(View view, int in) {
                Intent intent=new Intent(getActivity(),TuikuanTypeActivity.class);
                startActivity(intent);
            }
        });
//        mAdapter.setmTuikuanDetails(new CallBack.TuikuanDetailsListener() {
//            @Override
//            public void tuikuanDetails(View view, int in) {
//                Intent intent=new Intent(getActivity(),TuikuanDetailsActivity.class);
//                startActivity(intent);
//            }
//        });
