...
public class MyPopWindow implements OnDismissListener {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (event.getAction() != 0 || x >= 0 && x < MyPopWindow.this.mWidth && y >= 0 && y < MyPopWindow.this.mHeight) {
                        if (event.getAction() == 4) {
                            com.linzi.xiguwen.utils.LogUtil.e("CustomPopWindow", "out side ...");
                            return true;
                        } else {
                            return false;
                        }
                        ...
                        com.linzi.xiguwen.utils.LogUtil.e("CustomPopWindow", "out side ");
                        com.linzi.xiguwen.utils.LogUtil.e("CustomPopWindow", "width:" + MyPopWindow.this.mPopupWindow.getWidth() + "height:" + MyPopWindow.this.mPopupWindow.getHeight() + " x:" + x + " y  :" + y);
                        return true;
                    }
                }
            });
    ...
    public static class PopupWindowBuilder {
        ...
        public MyPopWindow.PopupWindowBuilder setOnDissmissListener(OnDismissListener onDissmissListener) {
        ...
        public MyPopWindow.PopupWindowBuilder setTouchIntercepter(OnTouchListener touchIntercepter) {
