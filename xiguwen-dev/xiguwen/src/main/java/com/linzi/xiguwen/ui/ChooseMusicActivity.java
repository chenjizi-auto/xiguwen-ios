...
import com.linzi.xiguwen.fragment.ChooseMusicFragment;
import com.linzi.xiguwen.net.OnRequestFinish;
import com.linzi.xiguwen.net.base.BaseBean;
import com.linzi.xiguwen.network.ApiManager;
import com.linzi.xiguwen.utils.LoadDialog;
import com.linzi.xiguwen.utils.MusicPlayer;
...
public class ChooseMusicActivity extends AppCompatActivity {
    private static MusicBean.DataBean mChooseMusic; // 选中的音乐
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtil.setStatusBarColor(ChooseMusicActivity.this, R.color.trans);
            StatusBarUtil.setNavigationBarColor(ChooseMusicActivity.this, R.color.white);
        }
    ...
    public void setChooseMusic(MusicBean.DataBean musicBean) {
        mChooseMusic = musicBean;
        mPlayer.play(musicBean);

        for (Fragment fragment : mFragmentList) {
            ((ChooseMusicFragment) fragment).notifyDataSetChange();
        }
    }
    ...
    public void finish() {
        if (mChooseMusic != null) {
            ...
            data.putExtra("data", mChooseMusic);
    ...
    private void requestTemplateTypes() {
        ...
        ApiManager.getMusicTypeList(new OnRequestFinish<BaseBean<List<InvitationsTemplateTypeBean>>>() {
            @Override
            ...
            public void onSuccess(BaseBean<List<InvitationsTemplateTypeBean>> data) {
                ...
                for (InvitationsTemplateTypeBean typeBean : mTypes) {
                    mFragmentList.add(ChooseMusicFragment.newInstance(typeBean,qingjianid));
