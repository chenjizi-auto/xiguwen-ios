...
import com.linzi.xiguwen.fragment.HunQinJieDanFragment;
...
public class HunQinJieDanActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"全部", "待付款", "待接单", "待服务", "已服务", "已成功","退款单"};
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(HunQinJieDanFragment.newInstance(x));
        }
