...
import com.linzi.xiguwen.fragment.HunQinOrderFragment;
...
public class HunQinOrderActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"全部", "待付款", "待接单", "待服务", "已服务", "成功"};
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(HunQinOrderFragment.newInstance(x));
        }
