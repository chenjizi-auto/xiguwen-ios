...
import com.linzi.xiguwen.fragment.BYXYMusicFragment;
import com.linzi.xiguwen.fragment.BYXYVideoFragment;
...
public class MineBYXYActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"视频", "音乐"};
...
//        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(new BYXYVideoFragment());
            mFragmentList.add(new BYXYMusicFragment());
//        }
