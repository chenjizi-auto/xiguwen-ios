...
import com.linzi.xiguwen.fragment.MineChakanNeedFragment;
...
public class MineChakanNeedActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"同城需求", "全国需求"};
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(MineChakanNeedFragment.newInstance(x));
        }
