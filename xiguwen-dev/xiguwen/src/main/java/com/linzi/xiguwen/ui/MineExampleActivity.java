...
import com.linzi.xiguwen.fragment.MineExampleFragment;
...
public class MineExampleActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        setRightAdd(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext,AddExampleActivity.class);
    ...
    private List<Fragment> getFragment() {
        ...
        mFragmentList.add(MineExampleFragment.newInstance(MyExampleBean.STATE_NO_SUBMIT_0));
        mFragmentList.add(MineExampleFragment.newInstance(MyExampleBean.STATE_ON));
        mFragmentList.add(MineExampleFragment.newInstance(MyExampleBean.STATE_PASS));
        mFragmentList.add(MineExampleFragment.newInstance(MyExampleBean.STATE_FAILED));
