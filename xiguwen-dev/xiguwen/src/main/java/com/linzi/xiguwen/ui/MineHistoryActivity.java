...
import com.linzi.xiguwen.fragment.HistoryGoodsFragment;
import com.linzi.xiguwen.fragment.HistoryPeoFragment;
...
public class MineHistoryActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"报价", "商品","商家"};
...
//        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(HistoryGoodsFragment.newInstance(0));
            mFragmentList.add(HistoryGoodsFragment.newInstance(0));
            mFragmentList.add(new HistoryPeoFragment());
//        }
