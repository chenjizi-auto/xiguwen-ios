...
import com.linzi.xiguwen.fragment.HunLiNewsFragment;
...
public class MineHunLiNewsActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"公告", "新闻资讯"};
    ...
    private List<Fragment> getFragment() {
        ...
        mFragmentList.add(HunLiNewsFragment.newInstance(WeddingNewsBean.TYPE_NOTIC));
        mFragmentList.add(HunLiNewsFragment.newInstance(WeddingNewsBean.TYPE_NEWS));
