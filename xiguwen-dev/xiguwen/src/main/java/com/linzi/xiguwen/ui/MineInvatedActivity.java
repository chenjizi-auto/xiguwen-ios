...
import com.linzi.xiguwen.adapter.TodayAddAdapter;
...
public class MineInvatedActivity extends BaseActivity {
...
//    private TodayAddAdapter mAdapter;
    private MineInvitationInfoBean mInfoBean;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mine_invated);
    ...
    protected void initData() {
        ...
        setRight("明细", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InvatedDetailsActivity.startActivity(MineInvatedActivity.this, mInfoBean.getList(), mCalendar);
            }
        });
    ...
    private void requestNetData(final Calendar calendar){
        ...
        ApiManager.getMineInvitationInfo(calendar.getTimeInMillis() / 1000, new OnRequestFinish<BaseBean<MineInvitationInfoBean>>() {
            ...
            public void onSuccess(BaseBean<MineInvitationInfoBean> data) {
                mInfoBean = data.getData();
                mCalendar = calendar;
                tvTime.setText(mFormat.format(calendar.getTime()));
                tvPeoNum.setText(mInfoBean.getNum() + "人");
                tvPrice.setText(mInfoBean.getMoney() + "元");
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.bt_last_day:
                ...
                break;
            case R.id.tv_time:
                new TimeSeletctUtil(MineInvatedActivity.this)
                        .isWhen(false)
