...
import com.linzi.xiguwen.fragment.MineNeedFragment;
...
public class MineNeedActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"全部", "进行中", "已结束"};
    ...
    private List<Fragment> getFragment() {
        ...
        mFragmentList.add(MineNeedFragment.newInstance(MineNeedBean.STATUS_ALL));
        mFragmentList.add(MineNeedFragment.newInstance(MineNeedBean.STATUS_HAND));
        mFragmentList.add(MineNeedFragment.newInstance(MineNeedBean.STATUS_END));
