...
import com.linzi.xiguwen.fragment.MinePingjiaFragment;
...
public class MinePingjiaActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"来自买家", "来自卖家"};
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(MinePingjiaFragment.newInstance(x));
        }
