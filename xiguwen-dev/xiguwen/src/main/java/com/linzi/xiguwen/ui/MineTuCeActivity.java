...
public class MineTuCeActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        setRightAdd(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext,AddTuCeActivity.class);
    ...
    private List<Fragment> getFragment() {
        ...
        mFragmentList.add(MineListFragment.newInstance(MineListActivity.TYPE_TUCE, BaseStatusBean.STATE_NO_SUBMIT_0));
        mFragmentList.add(MineListFragment.newInstance(MineListActivity.TYPE_TUCE, BaseStatusBean.STATE_ON));
        mFragmentList.add(MineListFragment.newInstance(MineListActivity.TYPE_TUCE, BaseStatusBean.STATE_PASS));
        mFragmentList.add(MineListFragment.newInstance(MineListActivity.TYPE_TUCE, BaseStatusBean.STATE_FAILED));
