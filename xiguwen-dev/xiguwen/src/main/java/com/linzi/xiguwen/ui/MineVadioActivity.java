...
import com.linzi.xiguwen.fragment.MineVadioFragment;
...
public class MineVadioActivity extends BaseActivity {
    ...
    private List<Fragment> getFragment() {
        ...
        mFragmentList.add(MineVadioFragment.newInstance(VideoBean.STATE_NO_SUBMIT_0));
        mFragmentList.add(MineVadioFragment.newInstance(VideoBean.STATE_ON));
        mFragmentList.add(MineVadioFragment.newInstance(VideoBean.STATE_PASS));
        mFragmentList.add(MineVadioFragment.newInstance(VideoBean.STATE_FAILED));
