...
public class OrderSearchResultActivity extends BaseActivity {
    ...
    private void getWeddingData(final boolean isLoadMore) {
        ...
        ApiManager.getWeddingOrderList("", content, page, limit, new OnRequestFinish<BaseBean<WeddingOrderListBean>>() {
            @Override
    ...
    private void getWeddingJieDanData(final boolean isLoadMore) {
        ctrlPublicParms(isLoadMore);
        ApiManager.getWeddingJieDanOrderList("", content, page, limit, new OnRequestFinish<BaseBean<WeddingJieDanOrderList>>() {
            @Override
            public void onFinished() {
                closeLoadingDialog(isLoadMore);
            }
        ...
        public WeddingItemHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(OrderSearchResultActivity.this, NewOrderDetailsActivity.class);
            ...
            switch (type) {
                case 10://待付款
                    ...
                    surebtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(OrderSearchResultActivity.this, ToPayActivity.class);
                ...
                case 60://待接单
                    ...
                    if (!bean.getAmount_balance().equals("0") && !bean.getAmount_balance().equals("0.00")) {
                        ...
                        surebtn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                GetPayPop getPayPop = new GetPayPop(OrderSearchResultActivity.this, new GetPayPop.GetPriceCallBack() {
                                    @Override
                    ...
                    switch (bean.getTuihuo()) {
                        case 1://用户可以申请退款
                            ...
                            surebtn.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent = new Intent(OrderSearchResultActivity.this, ShenQingTuikuanActivity.class);
                        ...
                        case 2://用户已申请退款
                            ...
                            surebtn.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent = new Intent(OrderSearchResultActivity.this, NewRefundDetailsActivity.class);
...
//                    } else
                ...
                case 80://待评价
                    ...
                    surebtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            //跳转评价activity
                            Intent intent = new Intent(OrderSearchResultActivity.this, PingjiaAdapterActivity.class);
                            intent.putExtra("intentType", intentType);
                            intent.putExtra("order_id", id);
                            OrderSearchResultActivity.this.startActivity(intent);
                        }
            ...
            switch (type) {
                case 10://待付款
                    ...
                    surebtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            //修改价格的操作
                            Intent intent = new Intent(OrderSearchResultActivity.this, EditPriceActivity.class);
                            intent.putExtra("intentType", intentType);
            ...
            switch (bean.getTuihuo()) {
                ...
                case 2://2是退款中
                    ...
                    thrBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(OrderSearchResultActivity.this, RefuseReasonActivity.class);
                            intent.putExtra("order_id", id);
                            OrderSearchResultActivity.this.startActivity(intent);
                        }
                    });
...
//            }
    ...
    private void createDel(String title, String content, String canleNam, String sureName, final String pid, final int order_id, final String price) {
        final AskDialog dialog = new AskDialog(OrderSearchResultActivity.this, OrderSearchResultActivity.this);
    ...
    private void createFinishOrderServerDialog(final int id, final String pid, final String price) {
        final ChoosePayDialog choosePayDialog = new ChoosePayDialog(OrderSearchResultActivity.this, OrderSearchResultActivity.this);
