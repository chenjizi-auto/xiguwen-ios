...
public class OtherTixingActivity extends BaseActivity {
...
//            }
            ...
            new TimeSeletctUtil(OtherTixingActivity.this)
                    .isWhen(true)
...
//        return dateFormat.format(calendar.getTime()) + " " + week;
    ...
    @OnClick({R.id.ll_hl_date, R.id.bt_submit})
            ...
            case R.id.bt_submit:
                if(check()){
                    if(mData == null){
                        ...
                        mData.setType(MyGradeBean.Grade.RemindData.TYPE_QITA);
                    }
