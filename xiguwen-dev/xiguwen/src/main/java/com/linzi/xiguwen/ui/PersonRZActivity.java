...
public class PersonRZActivity extends BaseActivity {
    ...
    String img_name_1, img_name_2, img_name_3;
    ...
    private void requestRZStatus() {
        ...
        ApiManager.getPersonCertificationStatus(new OnRequestFinish<BaseBean<CertificationsBean>>() {
            @Override
    ...
    private void refreshView(CertificationsBean data) {
        if (data != null) {
            ...
            if (!TextUtils.isEmpty(data.getIdentitya())) {
                img_name_1 = data.getIdentitya();
                GlideLoad.GlideLoadImg(this, img_name_1, ivCardZheng);
            }
            if (!TextUtils.isEmpty(data.getIdentityb())) {
                img_name_2 = data.getIdentityb();
                GlideLoad.GlideLoadImg(this, img_name_2, ivCardFan);
            }
            if (!TextUtils.isEmpty(data.getShou_chi_SFZ())) {
                img_name_3 = data.getShou_chi_SFZ();
                GlideLoad.GlideLoadImg(this, img_name_3, ivShouchi);
            }
        }
    }
    ...
    @OnClick({R.id.rl_zheng, R.id.rl_fan, R.id.rl_shouchi, R.id.bt_submit})
        ...
        XXPermissions.with(this)
                ...
                .request(new OnPermissionCallback() {
                    ...
                    public void onGranted(@NonNull List<String> permissions, boolean allGranted) {
                        if (!allGranted){
                            FullCommonPopWindow commonPopWindow = new FullCommonPopWindow(PersonRZActivity.this);
            ...
            PictureSelector.create(mContext)
                    ...
                    .forResult(new OnResultCallbackListener<LocalMedia>() {
                        ...
                        public void onResult(ArrayList<LocalMedia> result) {
                            ...
                            if (type == 1002){
                                img_name_1 = availablePath;
                                GlideLoad.GlideLoadImg(mContext, img_name_1, ivCardZheng);
                            }
                            if (type == 1003){
                                img_name_2 = availablePath;
                                GlideLoad.GlideLoadImg(mContext, img_name_2, ivCardFan);
                            }   if (type == 1004){
                                img_name_2 = availablePath;
                                GlideLoad.GlideLoadImg(mContext, img_name_3, ivShouchi);
                            }
    ...
    private boolean check() {
        ...
        if (img_name_2 == null || img_name_1 == null || img_name_3 == null) {
    ...
    private void uploadImg() {
        ...
        if (!img_name_1.toLowerCase().startsWith("http")) {
            uploadImgs.add(img_name_1);
        }
        if (!img_name_2.toLowerCase().startsWith("http")) {
            uploadImgs.add(img_name_2);
        }
        if (!img_name_3.toLowerCase().startsWith("http")) {
            uploadImgs.add(img_name_3);
        }
        ...
        for (final String uploadImg : uploadImgs) {
            ApiManager.uploadImgBase64(ImgCompressUtils.getBase64StrWithHead(uploadImg), new OnRequestFinish<BaseBean<String>>() {
                ...
                public void onSuccess(BaseBean<String> data) {
                    if (uploadImg.equals(img_name_1)) {
                        img_name_1 = data.getData();
                    } else if (uploadImg.equals(img_name_2)) {
                        img_name_2 = data.getData();
                    } else if (uploadImg.equals(img_name_3)) {
                        img_name_3 = data.getData();
                    }
                }
    ...
    private void submitOrder() {
        ...
        ApiManager.submitPersonCertification(edName.getText().toString().trim(), edCardId.getText().toString().trim(), img_name_1, img_name_2, img_name_3, new OnRequestFinish<BaseBean<String>>() {
            @Override
            public void onFinished() {
                MsgLoadDialog.CancelDialog();
            }
