...
import com.linzi.xiguwen.fragment.ShangChengOrderFragment;
...
public class ShangchengOrderActivity extends BaseActivity {
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(ShangChengOrderFragment.newInstance(x));
        }
