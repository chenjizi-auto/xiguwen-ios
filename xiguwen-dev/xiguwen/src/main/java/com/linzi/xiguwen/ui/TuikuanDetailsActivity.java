...
public class TuikuanDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuikuan_details);
    ...
    protected void initData() {
        ...
        llChexiao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(mContext,ShenQingZhongcaiActivity.class);
