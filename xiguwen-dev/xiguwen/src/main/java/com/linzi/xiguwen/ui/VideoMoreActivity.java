...
import com.linzi.xiguwen.fragment.VideoMoreFragment;
...
public class VideoMoreActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"推荐", "最新","最热"};
    ...
    private List<Fragment> getFragment() {
        ...
        for (int x = 0; x < mDataList.size(); x++) {
            mFragmentList.add(VideoMoreFragment.newInstance(x));
        }
