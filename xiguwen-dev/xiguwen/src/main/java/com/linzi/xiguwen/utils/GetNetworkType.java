...
public class GetNetworkType {
    ...
    /**
     * @param context
     * @return 0  无网络，1 gprs 流量
     */
    public static int getCurrentNetworkTypeInt(Context context) {
        int networkClass = getNetworkClass(context);
        int type = 1;
        switch (networkClass) {
            case NETWORK_CLASS_UNAVAILABLE:
    ...
    public static int getCurrentNetworkTypeAd(Context context) {
        int networkClass = getNetworkClass(context);
        int type = 1;
        switch (networkClass) {
            case NETWORK_CLASS_UNAVAILABLE:
    ...
    private static int getNetworkClassByType(int networkType,String strSubTypeName) {
        switch (networkType) {
    ...
    private static int getNetworkClass(Context context) {
        ...
        try {
            ...
            strSubTypeName= network.getSubtypeName();
        ...
        return getNetworkClassByType(networkType, strSubTypeName);
