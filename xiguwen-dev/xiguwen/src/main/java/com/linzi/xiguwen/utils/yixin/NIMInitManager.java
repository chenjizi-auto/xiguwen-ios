...
import com.linzi.xiguwen.utils.yixin.event.OnlineStateEventManager;
    ...
    private void registerLocaleReceiver(boolean register) {
        if (register) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                DemoCache.getContext().registerReceiver(localeReceiver, filter, Context.RECEIVER_EXPORTED);
            } else {
