...
//        options.mixPushConfig = buildMixPushConfig();
 ...
 public    static String getAppCacheDir(Context context) {
        ...
        try {
            ...
            // 该存储区在API 19以上不需要写权限，即可配置 <uses-permission android:name="android.permission.MANAGE_EXTERNAL_STORAGE" android:maxSdkVersion="18"/>
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.red_color);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.linzi.xiguwen/raw/msg";
