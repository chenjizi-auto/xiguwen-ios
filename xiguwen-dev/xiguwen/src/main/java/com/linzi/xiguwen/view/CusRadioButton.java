...
public class CusRadioButton extends RadioButton {
    ...
    public CusRadioButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            com.linzi.xiguwen.utils.LogUtil.i("MyRadioButton", "attr:" + attr);
            switch (attr) {
                case R.styleable.MyRadioButton_rbdrawableSize:
                    mDrawableSize = a.getDimensionPixelSize(R.styleable.MyRadioButton_rbdrawableSize, 50);
                    com.linzi.xiguwen.utils.LogUtil.i("MyRadioButton", "mDrawableSize:" + mDrawableSize);
                    break;
