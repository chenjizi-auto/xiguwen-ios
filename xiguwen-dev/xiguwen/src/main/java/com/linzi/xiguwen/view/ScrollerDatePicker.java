 ...
 * @author zihao
 */
public class ScrollerDatePicker extends View {
    /**
     * 控件宽度
     */
     ...
     * 设置数据
     */
    private ArrayList<MyDateBean> dataList = new ArrayList<>();
    /**
     * 按下的坐标
     */
    private int downY;
    ...
    public ScrollerDatePicker(Context context, AttributeSet attrs,
                              int defStyle) {
    ...
    public ScrollerDatePicker(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initData();
    }
    ...
    public void setControlWidth(int controlWidth,int controlHeight) {
        this.controlWidth = controlWidth;
//        this.unitHeight = 30;
//        this.maskHight = controlHeight/itemNumber;
//        this.controlHeight = itemNumber * unitHeight;
//        setMeasuredDimension(controlWidth, itemNumber * unitHeight);
        invalidate();
    }
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itmItemObject.id = i;
            itmItemObject.itemText = dataList.get(i).getDate();
            itmItemObject.x = 0;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        lineLeft = (int) attribute.getDimension(
                R.styleable.NumberPicker_leftMargin, 100);
        ...
        for (ItemObject item : itemList) {
            if (item.isSelected()) {
                for (int x = 0; x < dataList.size(); x++) {
                    if (item.itemText.equals(dataList.get(x).getDate())) {
                        return dataList.get(x).getId();
                    }
                }
            }
        }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            canvas.drawText(itemText, x + controlWidth / 2 - textRect.width()
                            / 2 + lineLeft , y + move + unitHeight / 2 + textRect.height() / 2,
                    textPaint);
