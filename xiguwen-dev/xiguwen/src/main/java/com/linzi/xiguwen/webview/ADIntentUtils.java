...
/**
 * Created by devin on 2017/9/22 15:22
 * Description
 */
public class ADIntentUtils {
    ...
    private boolean shouldOverrideUrlLoadingByAppInternal(WebView view, String url, boolean interceptExternalProtocol) {
        ...
        try {
            ...
            com.linzi.xiguwen.utils.LogUtil.e(TAG, "URISyntaxException: " + e.getLocalizedMessage());
        ...
        try {
            ...
            com.linzi.xiguwen.utils.LogUtil.e(TAG, "ActivityNotFoundException: " + e.getLocalizedMessage());
            return interceptExternalProtocol;
        }
        return true;
    }
    ...
    private boolean tryHandleByMarket(Intent intent) {
        ...
        if (packagename != null) {
            ...
            try{
                ...
                com.linzi.xiguwen.utils.LogUtil.e(TAG, "tryHandleByMarket ActivityNotFoundException: " + e.getLocalizedMessage());
                return false;
            }
            return true;
        } else {
