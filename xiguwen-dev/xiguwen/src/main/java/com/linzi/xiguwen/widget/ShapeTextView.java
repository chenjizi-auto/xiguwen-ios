...
public class ShapeTextView extends TextView {
    ...
    public void setSolidNormalColor(int colorId){
      solidNormalColor =  getResources().getColor(colorId);
      invalidate();
    }

    public void setSolidPressedColor(int colorId){
      solidPressedColor =   getResources().getColor(colorId);
      invalidate();
    }
