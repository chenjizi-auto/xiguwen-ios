...
public class SpringRecycleView extends RecyclerView implements View.OnTouchListener {
    ...
    public SpringRecycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SpringRecycleView(Context context, AttributeSet attrs, int defStyleAttr) {
