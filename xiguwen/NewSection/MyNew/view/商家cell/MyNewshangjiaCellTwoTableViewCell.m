...
- (void)awakeFromNib {
    ...
    [view setTag:62];
    [ControlCreator createImageView:view rect:CGRectMake(0, 0, 30, 30) image:[UIImage imageNamed:@"商家VIP"] backguoundColor:UIColorClear];
    [ControlCreator createQMLabel:view rect:CGRectMake(0, 0, 100, 20) text:@"充值" font:UIFontMake(16) color:UIColorBlack backguoundColor:nil align:NSTextAlignmentLeft lines:1];
    [ControlCreator createImageView:view rect:CGRectMake(0, 0, 30, 30) image:[UIImage imageNamed:@"点击进入"] backguoundColor:UIColorClear];
