...
- (void)cw_commonInit {
    ...
    [self cw_addArrangedSection:[self cw_makeOrderSectionWithTitle:@"婚庆接单"
...
- (NSArray<NSDictionary *> *)cw_managementItems {
    return @[
        ...
        @{@"tag": @33, @"title": @"发布档期", @"image": @"我的档期", @"iconWidth": @24, @"iconHeight": @24},
        @{@"tag": @34, @"title": @"发布报价", @"image": @"我的报价", @"iconWidth": @24, @"iconHeight": @24},
        @{@"tag": @36, @"title": @"上传图片", @"image": @"我的图册", @"iconWidth": @24, @"iconHeight": @24},
        @{@"tag": @37, @"title": @"上传视频", @"image": @"我的视频", @"iconWidth": @24, @"iconHeight": @24},
        @{@"tag": @38, @"title": @"上传案例", @"image": @"我的案例", @"iconWidth": @24, @"iconHeight": @24},
        @{@"tag": @39, @"title": @"服务城市", @"image": @"服务城市", @"iconWidth": @24, @"iconHeight": @24},
...
- (NSArray<NSDictionary *> *)cw_orderItems {
    return @[
        @{@"tag": @11, @"title": @"全部订单", @"image": @"全部订单", @"iconWidth": @22, @"iconHeight": @22},
        @{@"tag": @12, @"title": @"待付款", @"image": @"待付款", @"iconWidth": @22, @"iconHeight": @22},
        @{@"tag": @13, @"title": @"待接单", @"image": @"待接单2", @"iconWidth": @22, @"iconHeight": @22},
        @{@"tag": @14, @"title": @"待服务", @"image": @"待服务2", @"iconWidth": @22, @"iconHeight": @22},
        @{@"tag": @15, @"title": @"待评价", @"image": @"待评价", @"iconWidth": @22, @"iconHeight": @22}
    ];
}
...
- (UIView *)cw_makeGridSectionWithItems:(NSArray<NSDictionary *> *)items
    ...
    if (sectionName.length > 0) {
        [sectionStack addArrangedSubview:[self cw_makeTitleRow:sectionName]];
    }
    ...
    for (NSInteger row = 0; row < totalRows; row++) {
        ...
        [sectionStack addArrangedSubview:[self cw_makeGridRowWithItems:rowItems columns:columns]];
    }
...
- (UIView *)cw_makeOrderSectionWithTitle:(NSString *)title items:(NSArray<NSDictionary *> *)items {
    ...
    [sectionStack addArrangedSubview:[self cw_makeTitleRow:title]];
