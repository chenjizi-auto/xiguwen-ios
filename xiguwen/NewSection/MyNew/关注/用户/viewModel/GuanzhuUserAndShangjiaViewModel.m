//
//  GuanzhuUserAndShangjiaViewModel.m
//  BoYi
//
...
#import "GuanzhuUserAndShangjiaTableViewCell.h"

@implementation GuanzhuUserAndShangjiaViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[ShangjiaGuanzhuModel mj_objectArrayWithKeyValuesArray:object[@"yonghu"]]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GuanzhuUserAndShangjiaTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"GuanzhuUserAndShangjiaTableViewCell"];
