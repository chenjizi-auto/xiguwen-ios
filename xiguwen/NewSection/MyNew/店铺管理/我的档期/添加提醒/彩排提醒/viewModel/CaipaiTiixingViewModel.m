...
#import "CaipaiTiixingTableViewCell.h"

@implementation CaipaiTiixingViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[CaipaiTiixingViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CaipaiTiixingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CaipaiTiixingTableViewCell"];
