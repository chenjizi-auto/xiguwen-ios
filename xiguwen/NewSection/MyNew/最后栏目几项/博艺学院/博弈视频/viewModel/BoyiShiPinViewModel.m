...
@implementation BoyiShiPinViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[BoyiShiPinViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (RACCommand *)refreshDataCommand {
    ...
    if (!_refreshDataCommand) {
        ...
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            ...
            @strongify(self);
            return [[RequestManager sharedManager] RACRequestUrl:[HOMEURL stringByAppendingString:@"appapi/Boyicollege/collegevideolist"]
                                                          method:POST
                                                          loding:@"加载中..."
                                                             dic:input];
        }];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    BoyiShipinHeaderView *header = [[NSBundle mainBundle]loadNibNamed:@"BoyiShipinHeaderView" owner:nil options:nil].firstObject;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BoyiShiPinTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"BoyiShiPinTableViewCell"];
