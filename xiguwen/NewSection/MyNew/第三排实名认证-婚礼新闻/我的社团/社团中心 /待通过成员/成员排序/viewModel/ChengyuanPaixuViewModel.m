...
#import "ChengyuanPaixuTableViewCell.h"

@implementation ChengyuanPaixuViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[ChengyuanPaixuViewModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ChengyuanPaixuTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ChengyuanPaixuTableViewCell"];
