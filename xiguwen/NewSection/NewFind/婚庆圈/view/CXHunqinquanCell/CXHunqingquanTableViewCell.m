...
-(void)loadwithModel:(Hunqinnewarray *)model{
    ...
    for (NSInteger index = 0; index < model.photourl.count; index ++) {
        ...
        if(index < _iCONS.count){
            ...
            partimage.layer.cornerRadius = 6.0;
        ...
        [partimage sd_setImageWithURL:[NSURL URLWithString:imageurl] placeholderImage:contentPlaceholder];
        partimage.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.15];
