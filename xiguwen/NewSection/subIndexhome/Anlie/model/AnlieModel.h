...
@class Anliindexesarray;
@interface AnlieModel : NSObject

// custom code

@property (nonatomic, strong) NSArray<Anliindexesarray *> *ANliIndexesArray;

@end
@interface Anliindexesarray : NSObject
