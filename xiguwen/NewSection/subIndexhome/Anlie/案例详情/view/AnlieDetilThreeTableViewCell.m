...
- (void)awakeFromNib {
    ...
    self.collectionAddress.scrollEnabled = NO;
...
{
    CGFloat horizontalInset = 12.0;
    CGFloat itemSpacing = 5.0;
    CGFloat availableWidth = CGRectGetWidth(collectionView.bounds) - horizontalInset * 2.0 - itemSpacing;
...
{
    return UIEdgeInsetsMake(0, 12, 0, 12);//分别为上、左、下、右
}
