...
- (void)awakeFromNib {
    [super awakeFromNib];
    self.bigImage.layer.cornerRadius = 6.0;
    self.bigImage.layer.masksToBounds = YES;
    self.bigImageTwo.layer.cornerRadius = 6.0;
    self.bigImageTwo.layer.masksToBounds = YES;
    self.bigImagethree.layer.cornerRadius = 6.0;
    self.bigImagethree.layer.masksToBounds = YES;
...
- (void)layoutSubviews {
    ...
    self.headrImage.layer.cornerRadius = CGRectGetHeight(self.headrImage.bounds) / 2.0;
}
