...
@class UserShangchengsj,Shopshangchengsj;
@interface ShangchengsjNewDetilModel : NSObject

// custom code

@property (nonatomic, strong) UserShangchengsj *user;

@property (nonatomic, strong) NSArray<Shopshangchengsj *> *shop;



@end
@interface UserShangchengsj : NSObject
...
@interface Shopshangchengsj : NSObject
