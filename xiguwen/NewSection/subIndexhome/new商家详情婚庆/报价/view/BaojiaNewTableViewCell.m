...
{
    CGFloat totalWidth = CGRectGetWidth(collectionView.bounds) - kBaojiaHorizontalInset * 2 - kBaojiaItemSpacing;
    return CGSizeMake(floor(totalWidth / 2.0), 183);
