...
#import "lookHeaderView.h"

@implementation LookMingxiNewViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[Lookmingxi mj_objectArrayWithKeyValuesArray:object[@"data"]]];
...
- (RACCommand *)refreshDataCommand {
    ...
    if (!_refreshDataCommand) {
        ...
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            ...
            @strongify(self);
            return [self requestSignalWithUrl:URL_New_lookmingxi
                                      loading:@""
                                Authorization:@""
                                         info:input];
        }];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    lookHeaderView *header = [[NSBundle mainBundle]loadNibNamed:@"lookHeaderView" owner:nil options:nil].firstObject;
    header.frame = CGRectMake(0, 0, ScreenWidth, 48);
    header.title.text = self.dataArray[section].title;
    return header;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LookMingxiNewTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LookMingxiNewTableViewCell"];
    cell.model = self.dataArray[indexPath.section].data[indexPath.row];
    return  cell;
}
