//
//  CheckFriendsWeddingViewModel.m
//  BoYi
//
...
@implementation CheckFriendsWeddingViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[CheckFriendsWeddingModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CheckFriendsWeddingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CheckFriendsWeddingTableViewCell"];
