//
//  EvaluationManagementViewModel.m
//  BoYi
//
...
@implementation EvaluationManagementViewModel
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[EvaluationManagementModel mj_objectArrayWithKeyValuesArray:object]];
...
//            @strongify(self);
            return [[RequestManager sharedManager] RACRequestUrl:URL_orderEvaluationList
                                                          method:POST
                                                          loding:@""
                                                             dic:input];
        }];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EvaluationManagementTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"EvaluationManagementTableViewCell"];
