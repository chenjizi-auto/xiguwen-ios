...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.dataArray = @[@"查看朋友婚礼",@"我的银行卡",@"我的提现",@"客服电话：028-62528708",@"意见反馈",@"关于"].mutableCopy;
    }
    return self;
}
...
- (void)ConvertingToObject:(id)object isHeaderRefersh:(BOOL)isHeaderRefersh {
    ...
    [self.dataArray addObjectsFromArray:[MineModel mj_objectArrayWithKeyValuesArray:object]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = RGBA(101, 101, 101, 1);
    return  cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.selectItemSubject sendNext:@(indexPath.row)];//self.dataArray[indexPath.row]];
}
