...
@interface ZLRedPacketGoodsListView ()<UITableViewDelegate,UITableViewDataSource,ZLRedPacketGoodsListCellDelgate>
...
@implementation ZLRedPacketGoodsListView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [ZLRedPacketGoodsListCell reuseCellWithTableView:tableView IndexPath:indexPath Delegate:self Model:self.infoModel];
}
...
#pragma mark - ZLRedPacketGoodsListCellDelgate
